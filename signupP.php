...
if(array_key_exists("signupP",$_POST)){
  ...
  $sql = "SELECT username FROM `users` WHERE username ='".mysqli_real_escape_string($link, $_POST['usernameP'])."' LIMIT 1";
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
              <form id="form_signup" method="POST" action="signupP.php" enctype="multipart/form-data">
                <div class="loginField">
                <h2>-- SIGN UP --</h2>
                <h4>Part Timer</h4><br>
                <div><input type="text" name="usernameP" placeholder="Username">
                  <span class="highlight"></span><span class="bar"></span><br></div>

                <div><input type="password" name="passwordP" placeholder="Password">
                  <span class="highlight"></span><span class="bar"></span><br></div>

                <div><input type="text" name="fullnameP" placeholder="Full Name">
                  <span class="highlight"></span><span class="bar"></span><br></div>

                <div><input type="email" name="emailP" placeholder="Email">
                <span class="highlight"></span><span class="bar"></span><br></div>

                <div><input type="text" name="contactP" placeholder="Contact No">
                <span class="highlight"></span><span class="bar"></span><br></div>

                <button name="signupP" type="submit" class="btn btn-md">Create Account</button> &nbsp;
              </form>
        </div>
      </div>
    </div>
